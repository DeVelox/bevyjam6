...
pub const BUTTON_PRESSED_BACKGROUND_ALT: Color = Color::srgb(0.580, 0.286, 0.227);
...
pub const BLUE: Color = Color::srgb(0.200, 0.533, 0.871);
pub const YELLOW: Color = Color::srgb(0.953, 0.659, 0.200);
pub const ORANGE: Color = Color::srgb(0.871, 0.365, 0.227);
pub const PURPLE: Color = Color::srgb(0.369, 0.357, 0.549);
...
pub const INVERTED: Color = Color::srgb(0.925, 0.153, 0.247);
