...
pub(super) fn plugin(app: &mut App) {
    ...
    app.add_systems(OnEnter(Screen::Gameplay), (setup_egui, spawn_ui));
...
fn spawn_ui(mut commands: Commands) {
    commands.spawn((
        ...
        children![
            (widget::ui_split("Left Sidebar", AlignItems::FlexEnd),),
            (
                widget::ui_split("Right Sidebar", AlignItems::FlexStart),
                children![
                    (
